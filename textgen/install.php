...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <title><?php echo $website['name'];?> <?php echo $website['version'];?> installation</title>
   ...
   <body>
      ...
      <div id="hero">
         <div class="row container">
            <div class="col12">
               <h1><?php echo $website['name'];?> <?php echo $website['version'];?> installation</h1>
               <p>welcome to the <?php echo $website['name'];?> installation page, please fill out the website settings below and click install to finalize the changes.</p>
            </div>
         </div>
      </div>
      ...
      <div id="main">
         ...
         <div>
            <div class="row container">
               <div class="col6">
                  <button id="rating-button" class="green-btn">leave a rating</button>
               </div>
               <div class="col6">
                  <button id="follow-button" class="green-btn">follow themefairy</button>
               </div>
               <div class="col12">
                  <button id="install-button" class="blue-btn">install text generator</button>
               </div>
